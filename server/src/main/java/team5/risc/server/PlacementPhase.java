...
public class PlacementPhase {
  ...
  private void setOutStream(DataOutputStream dataOutputStream, ObjectOutputStream objectOutputStream,
  ...
  private void get_placements(Map map, int id, int total_units, MetaInfoPlacement strInfo, ArrayList<Region> regions)
      throws IOException {
